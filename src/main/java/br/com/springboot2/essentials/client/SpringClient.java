package br.com.springboot2.essentials.client;
...
public class SpringClient {
    public static void main(String[] args) {
        ...
        Anime kingdom = Anime.builder().name("Jaspion").build();
        ...
        ResponseEntity<Void> samuraiChamplooUpdate = new RestTemplate().exchange("http://localhost:8080/animes/",
                HttpMethod.PUT, new HttpEntity<>(animeToBeUpdate, createJsonHeader()), Void.class);
